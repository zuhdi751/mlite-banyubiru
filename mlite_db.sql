...
CREATE TABLE `data_tb` (
    ...
    `klasifikasi_riwayat_pengobatan` enum(
        'Baru',
        'Kambuh',
    ...
    `klasifikasi_status_hiv` enum(
        'Positif',
        'Negatif',
        'Tidak diketahui'
    ) DEFAULT NULL,
    `total_skoring_anak` enum(
        '1',
        '2',
        '3',
        '4',
    ...
    `konfirmasiSkoring5` enum(
        'Uji Tuberkulin Positif',
        'Ada Kontak TB Paru',
        'Uji Tuberkulin Negatif',
        'Tidak Ada Kontak TB Paru'
    ) DEFAULT NULL,
    `konfirmasiSkoring6` enum(
        'Ada Kontak TB Paru',
        'Tidak Ada',
        'Tidak Jelas Kontak TB Paru'
    ) DEFAULT NULL,
    ...
    `sebelum_pengobatan_hasil_mikroskopis` enum(
        'Negatif',
        '1-19',
        '1+',
        '2+',
    ...
    `sebelum_pengobatan_hasil_tes_cepat` enum(
        'Rif sensitif',
        'Rif resisten',
        'Negatif',
        'Rif Indeterminated',
    ...
    `sebelum_pengobatan_hasil_biakan` enum(
        'Negatif',
        '1-19 BTA',
        '1+',
        '2+',
    ...
    `hasil_mikroskopis_bulan_2` enum(
        'Negatif',
        '1-19',
        '1+',
        '2+',
    ...
    `hasil_mikroskopis_bulan_3` enum(
        'Negatif',
        '1-19',
        '1+',
        '2+',
    ...
    `hasil_mikroskopis_bulan_5` enum(
        'Negatif',
        '1-19',
        '1+',
        '2+',
    ...
    `akhir_pengobatan_hasil_mikroskopis` enum(
        'Negatif',
        '1-19',
        '1+',
        '2+',
...
VALUES (
    ...
    (
        ...
        "settings",
        "footer",
        "Copyright {?=date(\"Y\")?} &copy; by drg. F. Basoro. All rights reserved."
    ),
    (
        "11",
        "settings",
    ...
    (
        ...
        "settings",
        "wallpaper",
        "uploads/settings/wallpaper.jpg"
    ),
    (
        "13",
        "settings",
    ...
    (
        ...
        "anjungan",
        "text_anjungan",
        "Running text anjungan pasien mandiri....."
    ),
    (
        "58",
        "anjungan",
        "text_loket",
        "Running text display antrian loket....."
    ),
    (
        "59",
        "anjungan",
    ...
    (
        ...
        "anjungan",
        "text_laboratorium",
        "Running text display antrian laboratorium....."
    ),
    (
        "61",
        "anjungan",
        "text_apotek",
        "Running text display antrian apotek....."
    ),
    (
        "62",
        "anjungan",
        "text_farmasi",
        "Running text display antrian farmasi....."
    ),
    (
        "63",
        "anjungan",
        "vidio",
        "PLFtgYUkJmfyx7rESNFuRDUmhtkzSeFPQo"
    ),
    (
        "64",
        "api",
        "apam_key",
        "qtbexUAxzqO3M8dCOo2vDMFvgYjdUEdMLVo341"
    ),
    (
        "65",
        "api",
...
VALUES (
        ...
        "admin",
        "Administrator",
        "Admin ganteng baik hati, suka menabung dan tidak sombong.",
        "$2y$10$pgRnDiukCbiYVqsamMM3ROWViSRqbyCCL33N8.ykBKZx0dlplXe9i",
        NULL,
        NULL,
        NULL,
        "avatar6422cb573b50c.png",
        "info@mlite.id",
        "admin",
        "",
        "all"
    ...
    (
        ...
        "dr. Ataaka Muhammad",
        "-",
        "$2y$10$kuf2BxvViduBpUTn.6Nxsug3AskH/PGvXTSlfCfJqK8Ayb9a0.vqC",
        NULL,
        NULL,
        NULL,
        "avatar643a104444515.png",
        "info@mlite.id",
        "admin",
        "",
        "all"
...
CREATE TABLE `mlite_vedika` (
    ...
    `username` varchar(100) NOT NULL,
    PRIMARY KEY (`id`),
    KEY `idx_vedika_status_jenis_tgl` (
        `status`,
        `jenis`,
        `tgl_registrasi`
    ),
...
CREATE TABLE `penilaian_awal_keperawatan_igd` (
    ...
    `perilaku` enum(
        ...
        'Gangguan Memori',
        'Halusinasi',
        'Kecenderungan Percobaan Bunuh Diri',
        'Lainnya',
        '-'
    ) NOT NULL,
...
CREATE TABLE `penilaian_awal_keperawatan_ranap` (
    ...
    `pemeriksaan_susunan_kepala` enum(
        'TAK',
        'Hydrocephalus',
        'Hematoma',
        'Lain-lain'
    ...
    `pemeriksaan_susunan_wajah` enum(
        'TAK',
        'Asimetris',
        'Kelainan Kongenital'
    ) NOT NULL,
    `pemeriksaan_susunan_wajah_keterangan` varchar(50) NOT NULL,
    `pemeriksaan_susunan_leher` enum(
        'TAK',
        'Kaku Kuduk',
        'Pembesaran Thyroid',
        'Pembesaran KGB'
    ...
    `pemeriksaan_susunan_sensorik` enum(
        'TAK',
        'Sakit Nyeri',
        'Rasa kebas'
    ) NOT NULL,
    `pemeriksaan_kardiovaskuler_denyut_nadi` enum('Teratur', 'Tidak Teratur') NOT NULL,
    `pemeriksaan_kardiovaskuler_sirkulasi` enum(
        'Akral Hangat',
        'Akral Dingin',
        'Edema'
    ) NOT NULL,
    ...
    `pemeriksaan_respirasi_pola_nafas` enum(
        'Normal',
        'Bradipnea',
        'Tachipnea'
    ) NOT NULL,
    `pemeriksaan_respirasi_retraksi` enum(
        'Tidak Ada',
        'Ringan',
        'Berat'
    ) NOT NULL,
    `pemeriksaan_respirasi_suara_nafas` enum(
        'Vesikuler',
        'Wheezing',
        'Rhonki'
    ) NOT NULL,
    `pemeriksaan_respirasi_volume_pernafasan` enum(
        'Normal',
        'Hiperventilasi',
        'Hipoventilasi'
    ) NOT NULL,
    `pemeriksaan_respirasi_jenis_pernafasan` enum(
        'Pernafasan Dada',
        'Alat Bantu Pernafasaan'
    ) NOT NULL,
    ...
    `pemeriksaan_respirasi_batuk` enum(
        'Tidak',
        'Ya : Produktif',
        'Ya : Non Produktif'
    ) NOT NULL,
    `pemeriksaan_gastrointestinal_mulut` enum(
        'TAK',
        'Stomatitis',
        'Mukosa Kering',
        'Bibir Pucat',
    ...
    `pemeriksaan_gastrointestinal_gigi` enum(
        'TAK',
        'Karies',
        'Goyang',
        'Lain-lain'
    ...
    `pemeriksaan_gastrointestinal_lidah` enum(
        'TAK',
        'Kotor',
        'Gerak Asimetris',
        'Lain-lain'
    ...
    `pemeriksaan_gastrointestinal_tenggorokan` enum(
        'TAK',
        'Gangguan Menelan',
        'Sakit Menelan',
        'Lain-lain'
    ...
    `pemeriksaan_gastrointestinal_abdomen` enum(
        'Supel',
        'Asictes',
        ' Tegang',
        'Nyeri Tekan/Lepas',
    ...
    `pemeriksaan_gastrointestinal_peistatik_usus` enum(
        'TAK',
    ...
    `pemeriksaan_neurologi_alat_bantu_penglihatan` enum(
        'Tidak',
        'Kacamata',
        'Lensa Kontak'
    ) NOT NULL,
    `pemeriksaan_neurologi_pendengaran` enum(
        'TAK',
        'Berdengung',
        'Nyeri',
        'Tuli',
    ...
    `pemeriksaan_neurologi_sensorik` enum(
        'TAK',
        'Sakit Nyeri',
        'Rasa Kebas',
        'Lain-lain'
    ) NOT NULL,
    `pemeriksaan_neurologi_motorik` enum(
        'TAK',
        'Hemiparese',
        'Tetraparese',
        'Tremor',
    ...
    `pemeriksaan_integument_warnakulit` enum(
        'Pucat',
        'Sianosis',
        'Normal',
        'Lain-lain'
    ...
    `pemeriksaan_integument_kulit` enum(
        'Normal',
        'Rash/Kemerahan',
        'Luka',
        'Memar',
    ...
    `pemeriksaan_integument_dekubitas` enum(
        'Tidak Ada',
        'Usia > 65 tahun',
        'Obesitas',
        'Imobilisasi',
    ...
    `pola_aktifitas_makanminum` enum(
        'Mandiri',
        'Bantuan Orang Lain'
    ) NOT NULL,
    `pola_aktifitas_mandi` enum(
        'Mandiri',
        'Bantuan Orang Lain'
    ) NOT NULL,
    `pola_aktifitas_eliminasi` enum(
        'Mandiri',
        'Bantuan Orang Lain'
    ) NOT NULL,
    `pola_aktifitas_berpakaian` enum(
        'Mandiri',
        'Bantuan Orang Lain'
    ) NOT NULL,
    `pola_aktifitas_berpindah` enum(
        'Mandiri',
        'Bantuan Orang Lain'
    ) NOT NULL,
    ...
    `pola_tidur_gangguan` enum(
        'Tidak Ada Gangguan',
        'Insomnia'
    ) NOT NULL,
    `pengkajian_fungsi_kemampuan_sehari` enum(
        'Mandiri',
        'Bantuan Minimal',
        'Bantuan Sebagian',
        'Ketergantungan Total'
    ) NOT NULL,
    `pengkajian_fungsi_aktifitas` enum(
        'Tirah Baring',
        'Duduk',
        'Berjalan'
    ) NOT NULL,
    `pengkajian_fungsi_berjalan` enum(
        'TAK',
    ...
    `pengkajian_fungsi_ambulasi` enum(
        'Walker',
        'Tongkat',
        'Kursi Roda',
        'Tidak Menggunakan'
    ) NOT NULL,
    `pengkajian_fungsi_ekstrimitas_atas` enum(
        'TAK',
        'Lemah',
        'Oedema',
        'Tidak Simetris',
    ...
    `pengkajian_fungsi_ekstrimitas_bawah` enum(
        'TAK',
        'Varises',
        'Oedema',
        'Tidak Simetris',
    ...
    `riwayat_psiko_hubungan_keluarga` enum(
        'Harmonis',
        'Kurang Harmonis',
        'Tidak Harmonis',
        'Konflik Besar'
    ) NOT NULL,
    `riwayat_psiko_tinggal` enum(
        'Sendiri',
        'Orang Tua',
        'Suami/Istri',
        'Keluarga',
    ...
    `riwayat_psiko_pendidikan_pj` enum(
        '-',
        'TS',
        'TK',
        'SD',
    ...
    `penilaian_nyeri` enum(
        'Tidak Ada Nyeri',
        'Nyeri Akut',
        'Nyeri Kronis'
    ) NOT NULL,
    `penilaian_nyeri_penyebab` enum(
        'Proses Penyakit',
        'Benturan',
        'Lain-lain'
    ) NOT NULL,
    `penilaian_nyeri_ket_penyebab` varchar(50) NOT NULL,
    `penilaian_nyeri_kualitas` enum(
        'Seperti Tertusuk',
        'Berdenyut',
        'Teriris',
        'Tertindih',
    ...
    `penilaian_jatuhmorse_skala3` enum(
